...
/* package github.com/amnezia-vpn/amneziawg-apple */
...
extern char* LibXrayCutGeoData(char* datDir, char* dstDir, char* cutCodePath);
extern char* LibXrayLoadGeoData(char* datDir, char* name, char* geoType);
extern char* LibXrayPing(char* datDir, char* configPath, GoInt timeout, char* url, char* proxy);
extern char* LibXrayQueryStats(char* server, char* dir);
extern char* LibXrayCustomUUID(char* text);
extern char* LibXrayTestXray(char* datDir, char* configPath);
extern char* LibXrayRunXray(char* datDir, char* configPath, GoInt64 maxMemory);
extern char* LibXrayStopXray(void);
extern char* LibXrayXrayVersion(void);
